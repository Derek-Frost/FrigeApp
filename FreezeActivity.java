...
public class FreezeActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        Cursor category = mDb.rawQuery("SELECT title, quantity, weight, sell_by FROM productItems JOIN products ON productItems.productId = products.id WHERE productItems.refrigerator_id = 2 ", null);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.fab1).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(FreezeActivity.this, AddProductFreezeActivity.class);
